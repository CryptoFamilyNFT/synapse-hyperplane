//! Redb-backed locator implementation (Phase 1)
//!
//! Optimized for:
//! - Fast point lookups (pubkey -> AccountLocation)
//! - Batch writes (during initial scan)
//! - Pure Rust (no C++ build issues)
//!
//! Note: Can be migrated to RocksDB later for production with
//! `brew install rocksdb` and switching the backend.
