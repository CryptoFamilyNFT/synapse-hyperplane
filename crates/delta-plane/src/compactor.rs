...
impl Compactor {
    ...
    pub fn compact(
        ...
        let mut latest_deltas: HashMap<Pubkey, AccountLocation> = HashMap::new();
        for segment in &segments {
            // TODO: Read segment and extract locations
            // For now, use delta_locator's in-memory tracking
        }
